...
**Client:** The Wonky Labrador (via Blubutton Digital)
...
The Wonky Labrador initially wanted something straightforward - just a basic website with the usual pages you'd expect for a local business. Nothing fancy, just about, contact, opening hours, and I was manually adding their events as they came up.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
  <div className="text-center">
    <img src="/Images/wonky-web.jpg" alt="Homepage" className="w-full rounded-lg" />
    <p className="text-sm text-gray-600 mt-2">Homepage design</p>
  </div>
  <div className="text-center">
    <img src="/Images/wonky-web.jpg" alt="Shop page" className="w-full rounded-lg" />
    <p className="text-sm text-gray-600 mt-2">Integrated shop</p>
  </div>
</div>
