...
title: 'Volley Drills'
slug: 'volleydrills'
smallDescription: 'A platform for volleyball coaches to browse training drills, build session plans with timings and objectives, and export them as a PDF.'
...
# SEO Metadata
seo:
  title: 'Volley Drills - Laravel Training Management App for Volleyball Coaches'
  description: 'Full-stack Laravel and React application for volleyball coaches to manage training sessions, organise drills, and create session plans. Features drill categorisation, search functionality, and PDF export.'
  keywords:
    - 'Laravel volleyball app'
    - 'volleyball training management'
    - 'volleyball coaching software'
    - 'Laravel React Inertia'
    - 'volleyball drill organisation'
    - 'training session planner'
    - 'volleyball coaching tools'
    - 'Laravel full-stack development'
    - 'volleyball practice management'
    - 'coaching drill database'
    - 'volleyball session planning'
    - 'Laravel Inertia React'
  canonical: 'https://www.joshgretton.co.uk/projects/volleydrills'

  openGraph:
    title: 'Volley Drills - Laravel Training Management App for Volleyball Coaches'
    description: 'Full-stack Laravel and React application for volleyball coaches to manage training sessions, organise drills, and create session plans. Built with Laravel, React, and Inertia.js stack.'
    type: 'website'
    image: '/Images/volleyball-court.jpg'
    imageAlt: 'Volley Drills volleyball coaching application built with Laravel and React showing training session management'
    url: 'https://www.joshgretton.co.uk/projects/volleydrills'
  ...
  schema:
    ...
    name: 'Volley Drills'
    description: 'A comprehensive training management application for volleyball coaches built with Laravel and React. Features drill categorisation, session planning, PDF export, and user-generated content capabilities.'
    url: 'https://www.joshgretton.co.uk/projects/volleydrills'
    applicationCategory: 'Sports Training Management'
    operatingSystem: 'Web Browser'
    datePublished: '2024'
    screenshot: '/Images/volleyball-court.jpg'
    features:
      - 'Drill Database Management'
      - 'Session Planning Cart System'
      - 'PDF Export Functionality'
      - 'Drill Categorisation and Search'
      ...
      - 'Multi-version Development Approach'
    audience: 'Volleyball Coaches, Sports Trainers, Laravel Developers'
