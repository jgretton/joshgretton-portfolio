...
slug: 'wonkylab'
smallDescription: 'A website for a local micropub that started as a simple business site and grew into an e-commerce platform for merchandise and gift vouchers.'
technologies:
