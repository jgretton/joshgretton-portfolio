				...
				<div className="flex items-center gap-4">
					{liveUrl && (
						<HoverPrefetchLink
							href={liveUrl}
							target="_blank"
							className="group inline-flex items-center gap-1.5 text-xs font-light text-gray-400 decoration-2 underline-offset-2 transition-colors hover:text-gray-700 hover:underline dark:text-white/40 dark:hover:text-white/80"
						>
